...
<head>
    ...
    <link rel="stylesheet" href="/localhost/public/static/css/new_discipline.css">
</head>
<body>
<header>
    <div class="nav-bar">
...
<main>
    ...
    <form method="post">
        <input type="text" placeholder="Name for discipline">
        <input type="number" placeholder="Amount of hours">
